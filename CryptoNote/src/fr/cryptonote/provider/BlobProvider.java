...
public class BlobProvider {
	...
	public void blobStore(String sha, byte[] bytes) throws AppException {}

	public byte[] blobGet(String sha) throws AppException { return new byte[0]; }
	 ...
	 * @throws AppException
	 */
	 public boolean cleanup(HashSet<String> shas) throws AppException { return true; }
}
